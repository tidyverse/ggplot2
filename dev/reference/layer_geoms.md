...
[`layer()`](https://ggplot2.tidyverse.org/dev/reference/layer.md), you
need to provide the `"position"` argument as well. To give geoms as a
string, take the function name, and remove the `geom_` prefix, such that
`geom_point` becomes `"point"`.

Some of the more well known geoms that can be used for the `geom`
argument are:
[`"point"`](https://ggplot2.tidyverse.org/dev/reference/geom_point.md),
[`"line"`](https://ggplot2.tidyverse.org/dev/reference/geom_path.md),
[`"area"`](https://ggplot2.tidyverse.org/dev/reference/geom_ribbon.md),
[`"bar"`](https://ggplot2.tidyverse.org/dev/reference/geom_bar.md) and
[`"polygon"`](https://ggplot2.tidyverse.org/dev/reference/geom_polygon.md).
...
polygons and their
[positions](https://ggplot2.tidyverse.org/dev/reference/aes_position.md),
as well as graphical attributes, also termed aesthetics, such as
[colours,
fills](https://ggplot2.tidyverse.org/dev/reference/aes_colour_fill_alpha.md),
[linewidths and
linetypes](https://ggplot2.tidyverse.org/dev/reference/aes_linetype_size_shape.md).
...
classes that occupy a slot in a layer. All these classes inherit from
the parental
[`Geom`](https://ggplot2.tidyverse.org/dev/reference/Geom.md) ggproto
object that orchestrates how geoms work. Briefly, geoms are given the
opportunity to draw the data of the layer as a whole, a facet panel, or
of individual groups. For more information on extending geoms, see the
**Creating a new geom** section after running
