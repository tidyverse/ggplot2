...
- Scales that can be used to modify positions:
  [`scale_continuous()`](https://ggplot2.tidyverse.org/dev/reference/scale_continuous.md),
  [`scale_discrete()`](https://ggplot2.tidyverse.org/dev/reference/scale_discrete.md),
  [`scale_binned()`](https://ggplot2.tidyverse.org/dev/reference/scale_binned.md),
  [`scale_date()`](https://ggplot2.tidyverse.org/dev/reference/scale_date.md).
