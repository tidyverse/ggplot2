...
need to provide the `"position"` argument as well. To give stats as a
string, take the function name, and remove the `stat_` prefix, such that
`stat_bin` becomes `"bin"`.

Some of the more well known stats that can be used for the `stat`
argument are:
[`"density"`](https://ggplot2.tidyverse.org/dev/reference/geom_density.md),
[`"bin"`](https://ggplot2.tidyverse.org/dev/reference/geom_histogram.md),
[`"count"`](https://ggplot2.tidyverse.org/dev/reference/geom_bar.md),
[`"function"`](https://ggplot2.tidyverse.org/dev/reference/geom_function.md)
and
[`"smooth"`](https://ggplot2.tidyverse.org/dev/reference/geom_smooth.md).
...
in [`aes()`](https://ggplot2.tidyverse.org/dev/reference/aes.md).
...
the parental
[`Stat`](https://ggplot2.tidyverse.org/dev/reference/Stat.md) ggproto
object that orchestrates how stats work. Briefly, stats are given the
opportunity to perform computation either on the layer as a whole, a
facet panel, or on individual groups. For more information on extending
stats, see the **Creating a new stat** section after running
...
How [computed
aesthetics](https://ggplot2.tidyverse.org/dev/reference/aes_eval.md)
work.
