...
function instantiates the LayerInstance class, which inherits from
Layer, but has relevant fields populated.
...
- `stat_params,computed_stat_params`:
  ...
  [`layer()`](https://ggplot2.tidyverse.org/dev/reference/layer.md). The
...
- `mapping,computed_mapping`:
  ...
  These fields hold
  [mapping](https://ggplot2.tidyverse.org/dev/reference/aes.md)s. The
...
[`Layout`](https://ggplot2.tidyverse.org/dev/reference/Layout.md)
