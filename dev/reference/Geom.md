...
- `optional_aes`:
  ...
  are not required or described in the `default_aes` field.
...
- `draw_key`:
  ...
  [`draw_key_`](https://ggplot2.tidyverse.org/dev/reference/draw_key.md).
...
- `use_defaults`:
  ...
  **Description**
  ...
  - Handling the
    [`after_scale()`](https://ggplot2.tidyverse.org/dev/reference/aes_eval.md)/`stage(after_scale)`
  ...
  **Arguments**
  ...
  :   A [mapping](https://ggplot2.tidyverse.org/dev/reference/aes.md)
      with delayed evaluations.
  ...
  :   A [completed
      theme](https://ggplot2.tidyverse.org/dev/reference/complete_theme.md).
...
- `draw_panel,draw_group`:
  ...
  **Arguments**
  ...
  :   A `<Coord>` ggproto object. To correctly scale the position data,
      ...
      [munching](https://ggplot2.tidyverse.org/dev/reference/coord_munch.md).
