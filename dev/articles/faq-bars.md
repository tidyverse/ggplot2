...
If assigning color based on another variable, map the variable to the
...
Set the `width` of
[`geom_bar()`](https://ggplot2.tidyverse.org/dev/reference/geom_bar.md)
to a small value to obtain narrower bars with more space between them.
...
or
[`geom_col()`](https://ggplot2.tidyverse.org/dev/reference/geom_bar.md).
If you also want to show percentages on the axis, use
...
[`ggplot()`](https://ggplot2.tidyverse.org/dev/reference/ggplot.md) and
...
[`geom_col()`](https://ggplot2.tidyverse.org/dev/reference/geom_bar.md)
to draw the bars or let ggplot2 calculate the means with
...
[`ylim()`](https://ggplot2.tidyverse.org/dev/reference/lims.md) is a
