...
\section{Aesthetics}{
The following aesthetics can be used with stat\_bin2d.  Aesthetics are mapped to variables in the data with the aes function: \code{stat\_bin2d(aes(x = var))}
\itemize{
...
\usage{stat_bin2d(mapping = NULL, data = NULL, geom = "rect", position = "identity", 
    bins = 30, drop = TRUE, ...)}
\arguments{
