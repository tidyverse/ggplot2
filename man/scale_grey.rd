...
\usage{scale_colour_grey(name=NULL, start=0.2, end=0.8, limits=NULL, breaks=NULL, labels=NULL, ...)
scale_fill_grey(name=NULL, start=0.2, end=0.8, limits=NULL, breaks=NULL, labels=NULL, ...)}
\arguments{
