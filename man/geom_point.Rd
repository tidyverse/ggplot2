...
\details{
  ...
  severely distort the visual appearance of the plot.
  There is no one solution to this problem, but there are
  some techniques that can help.  You can add additional
...
overplotting}
\examples{p <- ggplot(mtcars, aes(wt, mpg))
p + geom_point()
