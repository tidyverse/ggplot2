...
*   ggplot2 now supports/uses tidy evaluation (as described below). This is a 
    ...
    The primary developer facing change is that `aes()` now contains use 
    quosures (expression + environment pairs) rather symbols, and you'll need 
    to take a different approach to extracting the information you need. A 
    common symptom of this change are errors "undefined columns selected" or 
