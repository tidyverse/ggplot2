...
[`geom_text()`](https://ggplot2.tidyverse.org/reference/geom_text.md) or
let [`ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.md)
...
[`ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.md) do the
counting for you, and access these counts with `after_stat(count)` that
is mapped to the labels to be placed on the plot with
[`stat_count()`](https://ggplot2.tidyverse.org/reference/geom_bar.md).
...
[`ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.md), draw
the segments with appropriate heights with `y = n` in the `aes`thetic
mapping and
[`geom_col()`](https://ggplot2.tidyverse.org/reference/geom_bar.md) to
draw the bars, and finally place the counts on the plot with
[`geom_text()`](https://ggplot2.tidyverse.org/reference/geom_text.md).
...
Another option is to let
[`ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.md) do the
calculation of proportions for you, and access these counts with
