...
[`aes()`](https://ggplot2.tidyverse.org/reference/aes.md) and
[`vars()`](https://ggplot2.tidyverse.org/reference/vars.md).
...
[`aes()`](https://ggplot2.tidyverse.org/reference/aes.md) at least once.
If your graphic uses facets, you might be using
[`vars()`](https://ggplot2.tidyverse.org/reference/vars.md) to refer to
columns in the plot/layer data. Both of these functions use non-standard
evaluation, so if you try to use them in a function within a package
they will result in a CMD check note:
...
pass it to [`aes()`](https://ggplot2.tidyverse.org/reference/aes.md) or
[`vars()`](https://ggplot2.tidyverse.org/reference/vars.md) using
...
[`aes()`](https://ggplot2.tidyverse.org/reference/aes.md) or
[`vars()`](https://ggplot2.tidyverse.org/reference/vars.md).
...
- If you would like the behaviour of `col` to look and feel like it
  would within [`aes()`](https://ggplot2.tidyverse.org/reference/aes.md)
  and [`vars()`](https://ggplot2.tidyverse.org/reference/vars.md), use
  `aes({{ col }})` or `vars({{ col }})`.
...
[`aes_()`](https://ggplot2.tidyverse.org/reference/aes_.md) or
[`aes_string()`](https://ggplot2.tidyverse.org/reference/aes_.md), as
they are deprecated and may be removed in a future version. Finally,
don’t skip the step of creating a data frame and a mapping to pass in to
[`ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.md) or its
layers! You will see other ways of doing this, but these may rely on
...
[`ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.md), which
is not displayed unless it is explicitly
[`print()`](https://rdrr.io/r/base/print.html)ed. Because of this,
ggplot2 defines its own generic
[`autoplot()`](https://ggplot2.tidyverse.org/reference/autoplot.md), a
call to which is expected to return a
[`ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.md) (with no
side effects).
...
of [`autoplot()`](https://ggplot2.tidyverse.org/reference/autoplot.md):
...
[`autoplot()`](https://ggplot2.tidyverse.org/reference/autoplot.md) if
you don’t own the S3 class, as it makes it hard for the package
...
existing theme
(e.g. [`theme_grey()`](https://ggplot2.tidyverse.org/reference/ggtheme.md))
...
[`get_layer_data()`](https://ggplot2.tidyverse.org/reference/ggplot_build.md)
