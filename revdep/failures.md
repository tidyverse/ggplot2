...
* Date/Publication: 2024-04-16 14:00:02 UTC
...
* Date/Publication: 2023-11-15 09:30:02 UTC
* Number of recursive dependencies: 109
...
*   checking whether package ‘ggpmisc’ can be installed ... ERROR
    ```
    Installation failed.
    See ‘/tmp/workdir/ggpmisc/new/ggpmisc.Rcheck/00install.out’ for details.
    ```
...
* removing ‘/tmp/workdir/ggpmisc/new/ggpmisc.Rcheck/ggpmisc’
...
Execution halted
ERROR: lazy loading failed for package ‘ggpmisc’
* removing ‘/tmp/workdir/ggpmisc/old/ggpmisc.Rcheck/ggpmisc’
...
Error: package or namespace load failed for ‘SeuratObject’ in loadNamespace(j <- i[[1L]], c(lib.loc, .libPaths()), versionCheck = vI[[j]]):
 namespace ‘Matrix’ 1.5-4.1 is being loaded, but >= 1.6.3 is required
Execution halted
...
* Date/Publication: 2024-01-11 10:10:02 UTC
* Number of recursive dependencies: 37
