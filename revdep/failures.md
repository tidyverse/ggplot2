...
* Version: NA
* GitHub: NA
* Source code: https://github.com/cran/groupedHyperframe
* Number of recursive dependencies: 77

Run `revdepcheck::cloud_details(, "groupedHyperframe")` for more info
...
* Date/Publication: 2025-08-21 08:30:02 UTC
...
```
* using log directory ‘/tmp/workdir/neatStats/new/neatStats.Rcheck’
* using R version 4.4.0 (2024-04-24)
* using platform: x86_64-pc-linux-gnu
* R was compiled by
    gcc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0
...
* using session charset: UTF-8
* using option ‘--no-manual’
* checking for file ‘neatStats/DESCRIPTION’ ... OK
...
* this is package ‘neatStats’ version ‘1.13.5’
* package encoding: UTF-8
* checking package namespace information ... OK
* checking package dependencies ... ERROR
...
```
* using log directory ‘/tmp/workdir/neatStats/old/neatStats.Rcheck’
* using R version 4.4.0 (2024-04-24)
* using platform: x86_64-pc-linux-gnu
* R was compiled by
    gcc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0
...
* Date/Publication: 2025-09-10 15:50:02 UTC
* Number of recursive dependencies: 480
...
* Version: 1.2
* GitHub: NA
* Source code: https://github.com/cran/Rnest
* Date/Publication: 2025-06-19 13:40:02 UTC
* Number of recursive dependencies: 86

Run `revdepcheck::cloud_details(, "Rnest")` for more info
...
```
* using log directory ‘/tmp/workdir/Rnest/new/Rnest.Rcheck’
* using R version 4.4.0 (2024-04-24)
* using platform: x86_64-pc-linux-gnu
* R was compiled by
    gcc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0
...
* using session charset: UTF-8
* using option ‘--no-manual’
* checking for file ‘Rnest/DESCRIPTION’ ... OK
...
* checking Rd \usage sections ... OK
* checking Rd contents ... OK
* checking for unstated dependencies in examples ... OK
...
```
* using log directory ‘/tmp/workdir/Rnest/old/Rnest.Rcheck’
* using R version 4.4.0 (2024-04-24)
* using platform: x86_64-pc-linux-gnu
* R was compiled by
    gcc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0
...
Run `revdepcheck::cloud_details(, "rosetta")` for more info
...
```
* using log directory ‘/tmp/workdir/rosetta/new/rosetta.Rcheck’
* using R version 4.4.0 (2024-04-24)
* using platform: x86_64-pc-linux-gnu
* R was compiled by
    gcc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0
...
* using session charset: UTF-8
* using option ‘--no-manual’
* checking for file ‘rosetta/DESCRIPTION’ ... OK
...
* checking contents of ‘data’ directory ... OK
* checking data for non-ASCII characters ... OK
* checking LazyData ... OK
...
```
* using log directory ‘/tmp/workdir/rosetta/old/rosetta.Rcheck’
* using R version 4.4.0 (2024-04-24)
* using platform: x86_64-pc-linux-gnu
* R was compiled by
    gcc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0
...
g++: fatal error: Killed signal terminated program cc1plus
compilation terminated.
make: *** [/opt/R/4.4.0/lib/R/etc/Makeconf:202: stanExports_continuous.o] Error 1
