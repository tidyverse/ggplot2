...
[`ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.md), supply
a dataset and aesthetic mapping (with
...
for 234 cars coloured by 7 'types' of car. The displacement and miles
per gallon are inversely
correlated.](reference/figures/README-example-1.png)
