...
1.  The \[community.rstudio.com\]\[<https://community.rstudio.com/>\] is
    a friendly place to ask any questions about
    ggplot2.

2.  [stackoverflow](http://stackoverflow.com/questions/tagged/ggplot2?sort=frequent&pageSize=50)
