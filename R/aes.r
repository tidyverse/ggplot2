...
# x is a vector of aes names, such as c("colour", "size", "shape")
standardize_aes_names <- function(x) {
...
rename_aes <- function(x) {
  names(x) <- standardize_aes_names(names(x))
  ...
  if (length(duplicated_names) > 0L) {
    ...
    warning(
      "Standardization of aesthetics has created duplicates for the ",
