...
#'
#' \itemize{
#'   \item Override either `draw_panel(self, data, panel_params, coord)` or
...
#'     draw.
#'   \item `draw_key`: Renders a single legend key.
...
#'   \item `reparameterise`: Converts width and height to xmin and xmax,
