ScaleLinetype <- proto(ScaleDiscrete, expr={
  ...
  output_set <- function(.) c("22", "44", "13", "1343", "73", "2262", "12223242", "F282", "F4448444", "224282F2", "F1")[seq_along(.$input_set())]
  max_levels <- function(.) 4
  
  detail <- "<p>Default line types supplied by Richard Pearson, University of Manchester.</p>"
