...
#'
#' @param binwidth The width of the bins. Can be specified as a numeric value, a function that calculates width from x or one of "Scott", "Sturgis", or "FD". The default is to use \code{bins}
...
StatBin <- ggproto("StatBin", Stat,
  setup_params = function(data, params) {
    ...
    if (is.null(params$breaks) && (is.null(params$binwidth) || !(is.numeric(params$binwidth) || is.function(params$binwidth) || params$binwidth %in% c('Sturgis', 'Scott', 'FD'))) && is.null(params$bins)) {
