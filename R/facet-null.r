...
FacetNull <- ggproto("FacetNull", Facet,
  ...
  draw_panels = function(panels, layout, x_scales, y_scales, ranges, coord, data, theme, params) {
    ...
    if (!is.null(params$x.secondary)) {
      if (!is.function(params$x.secondary)) stop("x.secondary must be a function", call. = FALSE)
    ...
    if (!is.null(params$y.secondary)) {
      if (!is.function(params$y.secondary)) stop("y.secondary must be a function", call. = FALSE)
