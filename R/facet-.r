...
#'
#' \itemize{
#'   \item `compute_layout`: Based on layer data compute a mapping between
...
#'   the panel.
#'
#'   \item `map_data`: This method is supplied the data for each layer in
...
#'   `facet_grid`.
#'
#'   \item `draw_panels`: This is where the panels are assembled into a
...
#'
#'   \item `draw_labels`: Given the gtable returned by `draw_panels`,
