...
GeomBoxplot <- ggproto("GeomBoxplot", Geom,
  ...
  default_aes = aes(weight = 1, colour = from_theme(col_mix(ink, paper, 0.2)),
                    fill = from_theme(paper), size = NULL,
    alpha = NA, shape = 19, linetype = "solid", linewidth = from_theme(thin)),
