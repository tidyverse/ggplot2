...
set_sec_axis <- function(sec.axis, scale) {
  if (!is.waive(sec.axis)) {
    ...
    if (!is.sec_axis(sec.axis)) cli::cli_abort("Secondary axes must be specified using {.fn sec_axis}")
...
AxisSecondary <- ggproto("AxisSecondary", NULL,
  ...
  init = function(self, scale) {
    ...
    if (!is.function(self$trans)) cli::cli_abort("Transformation for secondary axes must be a function")
