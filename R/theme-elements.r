...
element_line <- function(colour = NULL, linewidth = NULL, linetype = NULL,
  ...
  if (lifecycle::is_present(size)) {
    lifecycle::deprecate_soft("3.4.0", "element_line(size)", "element_line(linewidth)")
    linewidth <- size
  }
...
element_grob.element_rect <- function(element, x = 0.5, y = 0.5,
  ...
  if (lifecycle::is_present(size)) {
    lifecycle::deprecate_soft("3.4.0", "element_grob.element_rect(size)", "element_grob.element_rect(linewidth)")
    linewidth <- size
  }
...
element_grob.element_line <- function(element, x = 0:1, y = 0:1,
  ...
  if (lifecycle::is_present(size)) {
    lifecycle::deprecate_soft("3.4.0", "element_grob.element_line(size)", "element_grob.element_line(linewidth)")
    linewidth <- size
  }
