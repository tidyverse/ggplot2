...
scale_colour_steps <- function(..., low = "#132B43", high = "#56B1F7", space = "Lab",
  ...
  binned_scale(aesthetics = aesthetics, palette = seq_gradient_pal(low, high, space),
...
scale_colour_steps2 <- function(..., low = muted("red"), mid = "white", high = muted("blue"),
                                ...
                                aesthetics = "colour") {
  binned_scale(aesthetics = aesthetics, palette = div_gradient_pal(low, mid, high, space),
