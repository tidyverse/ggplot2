...
scale_colour_gradientn <- ScaleGradientCustome$build_accessor(c(variable = "\"colour\""))
scale_colour_gradientn <- ScaleGradientn$build_accessor(c(variable = "\"colour\""))
...
scale_fill_gradientn <- ScaleGradientCustome$build_accessor(c(variable = "\"fill\""))
scale_fill_gradientn <- ScaleGradientn$build_accessor(c(variable = "\"fill\""))
