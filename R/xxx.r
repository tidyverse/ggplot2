...
scale_x_discrete <- ScaleDiscrete$build_accessor(list(variable = "\"x\""))
...
scale_y_discrete <- ScaleDiscrete$build_accessor(list(variable = "\"y\""))
...
scale_z_asn <- ScaleAsn$build_accessor(list(variable = "\"z\""))
scale_z_atanh <- ScaleAtanh$build_accessor(list(variable = "\"z\""))
scale_z_continuous <- ScaleContinuous$build_accessor(list(variable = "\"z\""))
scale_z_discrete <- ScaleDiscrete$build_accessor(list(variable = "\"z\""))
scale_z_exp <- ScaleExp$build_accessor(list(variable = "\"z\""))
scale_z_inverse <- ScaleInverse$build_accessor(list(variable = "\"z\""))
scale_z_log <- ScaleLog$build_accessor(list(variable = "\"z\""))
scale_z_log10 <- ScaleLog10$build_accessor(list(variable = "\"z\""))
scale_z_log2 <- ScaleLog2$build_accessor(list(variable = "\"z\""))
scale_z_logit <- ScaleLogit$build_accessor(list(variable = "\"z\""))
scale_z_pow <- ScalePow$build_accessor(list(variable = "\"z\""))
scale_z_pow10 <- ScalePow10$build_accessor(list(variable = "\"z\""))
scale_z_prob <- ScaleProb$build_accessor(list(variable = "\"z\""))
scale_z_probit <- ScaleProbit$build_accessor(list(variable = "\"z\""))
scale_z_reverse <- ScaleReverse$build_accessor(list(variable = "\"z\""))
scale_z_sqrt <- ScaleSqrt$build_accessor(list(variable = "\"z\""))
