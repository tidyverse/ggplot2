...
coord_flip <- CoordFlipped$build_accessor()
coord_map <- CoordMap$build_accessor()
coord_polar <- CoordPolar$build_accessor()
coord_trans <- CoordTransform$build_accessor()
...
scale_colour_colour <- ScaleColour$build_accessor(c(variable = "\"colour\""))
scale_colour_continuous <- ScaleColourContinuous$build_accessor(c(variable = "\"colour\""))
...
scale_colour_hue <- ScaleColourDiscrete$build_accessor(c(variable = "\"colour\""))
...
scale_fill_colour <- ScaleColour$build_accessor(c(variable = "\"fill\""))
scale_fill_continuous <- ScaleColourContinuous$build_accessor(c(variable = "\"fill\""))
...
scale_fill_hue <- ScaleColourDiscrete$build_accessor(c(variable = "\"fill\""))
...
scale_x_pow <- ScalePower$build_accessor(c(variable = "\"x\""))
scale_x_pow10 <- ScalePow10$build_accessor(c(variable = "\"x\""))
scale_x_prob <- ScaleProbability$build_accessor(c(variable = "\"x\""))
...
scale_xend_pow <- ScalePower$build_accessor(c(variable = "\"xend\""))
scale_xend_pow10 <- ScalePow10$build_accessor(c(variable = "\"xend\""))
scale_xend_prob <- ScaleProbability$build_accessor(c(variable = "\"xend\""))
...
scale_y_pow <- ScalePower$build_accessor(c(variable = "\"y\""))
scale_y_pow10 <- ScalePow10$build_accessor(c(variable = "\"y\""))
scale_y_prob <- ScaleProbability$build_accessor(c(variable = "\"y\""))
...
scale_yend_pow <- ScalePower$build_accessor(c(variable = "\"yend\""))
scale_yend_pow10 <- ScalePow10$build_accessor(c(variable = "\"yend\""))
scale_yend_prob <- ScaleProbability$build_accessor(c(variable = "\"yend\""))
...
scale_z_pow <- ScalePower$build_accessor(c(variable = "\"z\""))
scale_z_pow10 <- ScalePow10$build_accessor(c(variable = "\"z\""))
scale_z_prob <- ScaleProbability$build_accessor(c(variable = "\"z\""))
