...
This vignette documents the official extension mechanism provided in ggplot2 1.1.0. This vignette is a high-level adjunct to the low-level details found in `?Stat`, `?Geom` and `?theme`. You'll learn how to extending ggplot2 by creating a new stat, geom, or theme.
...
Instead of modifying an existing theme piecemeal, you might want to start from scratch and create your own unique theme. If you want to create your complete theme, you'll need to understand a bit more about the structure of themes.
