...
```{r example_scales}
#| fig.alt = "A scatterplot showing city versus highway miles per gallon for 
#|  234 cars. The points are coloured according to seven classes of cars."
...
```{r example_coords}
#| fig.alt = "A scatterplot showing city versus highway miles per gallon for 
#|  234 cars. The aspect ratio of the plot is such that units on the x-axis
...
```{r example_theme}
#| fig.alt = "A scatterplot showing city versus highway miles per gallon for 
#|  234 cars. The points are coloured according to seven classes of cars. The
