...
Customise the `breaks` and `minor_breaks` in `scale_x_continuous()`, scale_y_continuous()`, etc. See [How do I increase / decrease the number of axis ticks?](#how-do-i-increase-decrease-the-number-of-axis-ticks-) for more detail.
