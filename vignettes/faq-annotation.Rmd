...
### Why is annotation created with `geom_text()` pixellated?
...
ggplot(mpg, aes(x = hwy)) +
  ...
  geom_segment(x = mean_hwy, xend = mean_hwy,
               y = 0, yend = 35,
               color = "red") +
  geom_text(x = mean_hwy, y = 40, 
...
### How can I avoid overlapping text labels on a scatterplot?
