...
- geom, stat:
  ...
  Use to override the default connection between `geom_quantile()` and
  `stat_quantile()`. For more information about overriding these
...
`geom_quantile()` understands the following aesthetics. Required
