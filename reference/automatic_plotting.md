...
and [`fortify()`](https://ggplot2.tidyverse.org/reference/fortify.md).
...
the [`fortify()`](https://ggplot2.tidyverse.org/reference/fortify.md)
...
implemented a
[`fortify()`](https://ggplot2.tidyverse.org/reference/fortify.md) method
for your data type, you might have to reshape the data in
[`autolayer()`](https://ggplot2.tidyverse.org/reference/autolayer.md).
