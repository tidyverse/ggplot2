...
[`geom_tile()`](https://ggplot2.tidyverse.org/reference/geom_tile.md) to
...
with [delayed
evaluation](https://ggplot2.tidyverse.org/reference/aes_eval.md). The
computed variables differ somewhat for contour lines (computed by
...
| •   | **[`y`](https://ggplot2.tidyverse.org/reference/aes_position.md)**         |                       |
| •   | **`z`**                                                                    |                       |
| •   | [`fill`](https://ggplot2.tidyverse.org/reference/aes_colour_fill_alpha.md) | → `after_stat(level)` |
| •   | [`group`](https://ggplot2.tidyverse.org/reference/aes_group_order.md)      | → inferred            |
| •   | `order`                                                                    | → `after_stat(level)` |
