...
in [`ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.md) and
...
[`vars()`](https://ggplot2.tidyverse.org/reference/vars.md) for another
quoting function designed for faceting specifications.
...
[Delayed
evaluation](https://ggplot2.tidyverse.org/reference/aes_eval.md) for
