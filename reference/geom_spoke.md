...
It is useful when you have variables that describe direction and
distance. The angles start from east and increase counterclockwise.
...
`geom_spoke()` understands the following aesthetics. Required aesthetics
