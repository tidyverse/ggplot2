...
[`geom_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) framework
and does not work with sf geometry columns as input. However, it can be
used in conjunction with
[`geom_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) layers
and/or [`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md)
(see examples).
...
- map:
  ...
  created using
  [`fortify()`](https://ggplot2.tidyverse.org/reference/fortify.md) on a
  spatial object. It must contain columns `x` or `long`, `y` or `lat`,
  and `region` or `id`.
