...
- theme:
  ...
  An incomplete
  [theme](https://ggplot2.tidyverse.org/reference/theme.md) object to
  complete, or `NULL` to complete the default theme.

- default:

  A complete [theme](https://ggplot2.tidyverse.org/reference/theme.md)
  to fill in missing pieces. Defaults to the global theme settings.
