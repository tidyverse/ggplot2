...
|     |                                                                                                                                                                                                                  |            |
|-----|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|
| •   | **[`x`](https://ggplot2.tidyverse.org/reference/aes_position.md) *or* [`xmin`](https://ggplot2.tidyverse.org/reference/aes_position.md) *or* [`xmax`](https://ggplot2.tidyverse.org/reference/aes_position.md)** |            |
| •   | **[`y`](https://ggplot2.tidyverse.org/reference/aes_position.md) *or* [`ymin`](https://ggplot2.tidyverse.org/reference/aes_position.md) *or* [`ymax`](https://ggplot2.tidyverse.org/reference/aes_position.md)** |            |
