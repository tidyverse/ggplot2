...
|     |                                                                                                                                                                                                                                |                                                                     |
|-----|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| •   | **[`x`](https://ggplot2.tidyverse.org/reference/aes_position.md) *or* `width` *or* [`xmin`](https://ggplot2.tidyverse.org/reference/aes_position.md) *or* [`xmax`](https://ggplot2.tidyverse.org/reference/aes_position.md)**  |                                                                     |
| •   | **[`y`](https://ggplot2.tidyverse.org/reference/aes_position.md) *or* `height` *or* [`ymin`](https://ggplot2.tidyverse.org/reference/aes_position.md) *or* [`ymax`](https://ggplot2.tidyverse.org/reference/aes_position.md)** |                                                                     |
