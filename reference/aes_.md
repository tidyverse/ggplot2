...
[`aes()`](https://ggplot2.tidyverse.org/reference/aes.md) uses
...
call to [`aes()`](https://ggplot2.tidyverse.org/reference/aes.md).
...
[`vignette("ggplot2-in-packages")`](https://ggplot2.tidyverse.org/articles/ggplot2-in-packages.md).
