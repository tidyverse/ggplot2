...
[`geom_path()`](https://ggplot2.tidyverse.org/reference/geom_path.md) if
you need to connect points across multiple cases.
...
| •   | **[`xend`](https://ggplot2.tidyverse.org/reference/aes_position.md) *or* [`yend`](https://ggplot2.tidyverse.org/reference/aes_position.md)** |                                                                     |
