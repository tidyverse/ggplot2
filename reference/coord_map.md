...
[`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md), and
should no longer be used in new code. All regular (non-sf) geoms can be
used with
[`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) by
...
and [`geom_map()`](https://ggplot2.tidyverse.org/reference/geom_map.md).
