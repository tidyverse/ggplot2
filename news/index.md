...
- [`geom_text()`](https://ggplot2.tidyverse.org/reference/geom_text.md)
  and
  [`geom_label()`](https://ggplot2.tidyverse.org/reference/geom_text.md)
  accept expressions as the `label` aesthetic
  ([@teunbrand](https://github.com/teunbrand),
  [\#6638](https://github.com/tidyverse/ggplot2/issues/6638))
- Fixed regression where
  [`draw_key_rect()`](https://ggplot2.tidyverse.org/reference/draw_key.md)
...
- Out-of-bounds datapoints used as padding by
  [`stat_align()`](https://ggplot2.tidyverse.org/reference/geom_ribbon.md)
...
- (Breaking) The defaults for all geoms can be set at one in the theme.
  ...
  - The
    [`from_theme()`](https://ggplot2.tidyverse.org/reference/aes_eval.md)
...
- Default labels are derived in `build_ggplot()` (previously
  ...
  [`update_ggplot()`](https://ggplot2.tidyverse.org/reference/update_ggplot.md)
...
- [`annotation_borders()`](https://ggplot2.tidyverse.org/reference/annotation_borders.md)
  ...
  [`borders()`](https://ggplot2.tidyverse.org/reference/annotation_borders.md)
  ([@teunbrand](https://github.com/teunbrand),
  [\#6392](https://github.com/tidyverse/ggplot2/issues/6392))

- Turned off fallback for `size` to `linewidth` translation in
  [`geom_bar()`](https://ggplot2.tidyverse.org/reference/geom_bar.md)/[`geom_col()`](https://ggplot2.tidyverse.org/reference/geom_bar.md)
...
- The following methods have been deprecated:
  [`fortify.lm()`](https://ggplot2.tidyverse.org/reference/fortify.lm.md),
  [`fortify.glht()`](https://ggplot2.tidyverse.org/reference/fortify-multcomp.md),
  [`fortify.confint.glht()`](https://ggplot2.tidyverse.org/reference/fortify-multcomp.md),
  [`fortify.summary.glht()`](https://ggplot2.tidyverse.org/reference/fortify-multcomp.md)
  and
  [`fortify.cld()`](https://ggplot2.tidyverse.org/reference/fortify-multcomp.md).
...
- [`geom_errorbarh()`](https://ggplot2.tidyverse.org/reference/geom_linerange.md)
...
- Special getter and setter functions have been renamed for consistency,
  ...
  | New name                                                                        | Old name                                                                    |
  |---------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
  | [`get_theme()`](https://ggplot2.tidyverse.org/reference/get_theme.md)           | [`theme_get()`](https://ggplot2.tidyverse.org/reference/get_theme.md)       |
  | [`set_theme()`](https://ggplot2.tidyverse.org/reference/get_theme.md)           | [`theme_set()`](https://ggplot2.tidyverse.org/reference/get_theme.md)       |
  | [`replace_theme()`](https://ggplot2.tidyverse.org/reference/get_theme.md)       | [`theme_replace()`](https://ggplot2.tidyverse.org/reference/get_theme.md)   |
  | [`update_theme()`](https://ggplot2.tidyverse.org/reference/get_theme.md)        | [`theme_update()`](https://ggplot2.tidyverse.org/reference/get_theme.md)    |
  | [`get_last_plot()`](https://ggplot2.tidyverse.org/reference/get_last_plot.md)   | [`last_plot()`](https://ggplot2.tidyverse.org/reference/get_last_plot.md)   |
  | [`get_layer_data()`](https://ggplot2.tidyverse.org/reference/ggplot_build.md)   | [`layer_data()`](https://ggplot2.tidyverse.org/reference/ggplot_build.md)   |
  | [`get_layer_grob()`](https://ggplot2.tidyverse.org/reference/ggplot_build.md)   | [`layer_grob()`](https://ggplot2.tidyverse.org/reference/ggplot_build.md)   |
  | [`get_panel_scales()`](https://ggplot2.tidyverse.org/reference/ggplot_build.md) | [`layer_scales()`](https://ggplot2.tidyverse.org/reference/ggplot_build.md) |
...
- [`coord_trans()`](https://ggplot2.tidyverse.org/reference/coord_transform.md)
  was renamed to
...
- The [`theme()`](https://ggplot2.tidyverse.org/reference/theme.md)
...
- Adjustments to margins
  ...
  - New
    [`margin_part()`](https://ggplot2.tidyverse.org/reference/element.md)
  ...
  - New
    [`margin_auto()`](https://ggplot2.tidyverse.org/reference/element.md)
...
- [`theme_classic()`](https://ggplot2.tidyverse.org/reference/ggtheme.md)
...
- Changes in discrete scales:
  ...
  - Added `sec.axis` argument. Discrete scales don’t support
    ...
    [`dup_axis()`](https://ggplot2.tidyverse.org/reference/sec_axis.md)
...
- Reversal of a dimension, typically ‘x’ or ‘y’, is now controlled by
  ...
  [`coord_fixed()`](https://ggplot2.tidyverse.org/reference/coord_fixed.md),
  [`coord_radial()`](https://ggplot2.tidyverse.org/reference/coord_radial.md)
  and [`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md).
  In
  [`coord_radial()`](https://ggplot2.tidyverse.org/reference/coord_radial.md),
...
- New `coord_cartesian(ratio)` argument that absorbs the aspect ratio
  functionality from
  [`coord_equal()`](https://ggplot2.tidyverse.org/reference/coord_fixed.md)
  and
  [`coord_fixed()`](https://ggplot2.tidyverse.org/reference/coord_fixed.md),
  which are now wrappers for
  [`coord_cartesian()`](https://ggplot2.tidyverse.org/reference/coord_cartesian.md).
- In non-orthogonal coordinate systems
  ([`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md),
  [`coord_polar()`](https://ggplot2.tidyverse.org/reference/coord_radial.md)
  and
  [`coord_radial()`](https://ggplot2.tidyverse.org/reference/coord_radial.md)),
...
- New
  [`stat_connect()`](https://ggplot2.tidyverse.org/reference/stat_connect.md)
  to connect points via steps or other shapes
  ([@teunbrand](https://github.com/teunbrand),
  [\#6228](https://github.com/tidyverse/ggplot2/issues/6228))
- New stat:
  [`stat_manual()`](https://ggplot2.tidyverse.org/reference/stat_manual.md)
...
- New default `geom_qq_line(geom = "abline")` for better clipping in the
  ...
  [`stat_qq_line()`](https://ggplot2.tidyverse.org/reference/geom_qq.md)
  ([@teunbrand](https://github.com/teunbrand),
  [\#6087](https://github.com/tidyverse/ggplot2/issues/6087)).
- [`stat_ecdf()`](https://ggplot2.tidyverse.org/reference/stat_ecdf.md)
...
- The `arrow.fill` parameter is now applied to more line-based
  ...
  [`geom_step()`](https://ggplot2.tidyverse.org/reference/geom_path.md)
  [`geom_function()`](https://ggplot2.tidyverse.org/reference/geom_function.md),
  line geometries in
  [`geom_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) and
...
- All binning stats now use the `boundary`/`center` parametrisation
  ...
  [`stat_bin()`](https://ggplot2.tidyverse.org/reference/geom_histogram.md)’s
...
- [`after_stat()`](https://ggplot2.tidyverse.org/reference/aes_eval.md)
  and
  [`after_scale()`](https://ggplot2.tidyverse.org/reference/aes_eval.md)
...
- [`geom_hline()`](https://ggplot2.tidyverse.org/reference/geom_abline.md)
  and
...
- The ellipsis argument is now checked in
  ...
  [`labs()`](https://ggplot2.tidyverse.org/reference/labs.md) and
  several guides. ([@teunbrand](https://github.com/teunbrand),
  [\#3196](https://github.com/tidyverse/ggplot2/issues/3196)).
- [`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.md) can
  write a multi-page pdf file when provided with a list of plots
  ([@teunbrand](https://github.com/teunbrand),
...
- Fixed bug in
  [`guide_custom()`](https://ggplot2.tidyverse.org/reference/guide_custom.md)
  that would throw error with
  [`theme_void()`](https://ggplot2.tidyverse.org/reference/ggtheme.md)
  ([@teunbrand](https://github.com/teunbrand),
...
- The size of the
  [`draw_key_polygon()`](https://ggplot2.tidyverse.org/reference/draw_key.md)
...
- Fixed regression with incorrectly drawn gridlines when using
  [`coord_flip()`](https://ggplot2.tidyverse.org/reference/coord_flip.md)
  ([@teunbrand](https://github.com/teunbrand),
...
- Position scales combined with
  [`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) can
  now use functions in the `breaks` argument. In addition, `n.breaks`
  works as intended and `breaks = NULL` removes grid lines and axes
  ([@teunbrand](https://github.com/teunbrand),
  [\#4622](https://github.com/tidyverse/ggplot2/issues/4622)).
- [`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) no
...
- Fixed bug in
  [`position_dodge2()`](https://ggplot2.tidyverse.org/reference/position_dodge.md)’s
...
- [`geom_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) now
...
- [`geom_rug()`](https://ggplot2.tidyverse.org/reference/geom_rug.md)
...
- [`geom_abline()`](https://ggplot2.tidyverse.org/reference/geom_abline.md)
...
- [`stat_summary_2d()`](https://ggplot2.tidyverse.org/reference/stat_summary_2d.md)
  and
...
- [`stat_summary_bin()`](https://ggplot2.tidyverse.org/reference/stat_summary.md)
...
- Fixed bug where the `ggplot2::`-prefix did not work with
  [`stage()`](https://ggplot2.tidyverse.org/reference/aes_eval.md)
  ([@teunbrand](https://github.com/teunbrand),
...
- New helper function
  [`gg_par()`](https://ggplot2.tidyverse.org/reference/gg_par.md) to
...
- The helper function
  [`is_waiver()`](https://ggplot2.tidyverse.org/reference/waiver.md) is
  now exported to help extensions to work with
...
- [`update_geom_defaults()`](https://ggplot2.tidyverse.org/reference/update_defaults.md)
  and
  [`update_stat_defaults()`](https://ggplot2.tidyverse.org/reference/update_defaults.md)
  have a reset mechanism when using `new = NULL` and invisible return
  the previous defaults
  ([\#4993](https://github.com/tidyverse/ggplot2/issues/4993)).
- New
  [`reset_geom_defaults()`](https://ggplot2.tidyverse.org/reference/update_defaults.md)
  and
  [`reset_stat_defaults()`](https://ggplot2.tidyverse.org/reference/update_defaults.md)
  to restore all geom or stat default aesthetics at once
  ([@teunbrand](https://github.com/teunbrand),
  [\#5975](https://github.com/tidyverse/ggplot2/issues/5975)).
- New function
  [`complete_theme()`](https://ggplot2.tidyverse.org/reference/complete_theme.md)
...
- Applying defaults in
  [`geom_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) has
...
- Standardised test functions for important classes:
  [`is_ggproto()`](https://ggplot2.tidyverse.org/reference/is_tests.md),
  [`is_ggplot()`](https://ggplot2.tidyverse.org/reference/is_tests.md),
  [`is_mapping()`](https://ggplot2.tidyverse.org/reference/is_tests.md),
  [`is_layer()`](https://ggplot2.tidyverse.org/reference/is_tests.md),
  [`is_geom()`](https://ggplot2.tidyverse.org/reference/is_tests.md),
  [`is_stat()`](https://ggplot2.tidyverse.org/reference/is_tests.md),
  [`is_position()`](https://ggplot2.tidyverse.org/reference/is_tests.md),
  [`is_coord()`](https://ggplot2.tidyverse.org/reference/is_tests.md),
  [`is_facet()`](https://ggplot2.tidyverse.org/reference/is_tests.md),
  [`is_scale()`](https://ggplot2.tidyverse.org/reference/is_tests.md),
  [`is_guide()`](https://ggplot2.tidyverse.org/reference/is_tests.md),
  [`is_guides()`](https://ggplot2.tidyverse.org/reference/is_tests.md),
  [`is_margin()`](https://ggplot2.tidyverse.org/reference/is_tests.md),
  [`is_theme_element()`](https://ggplot2.tidyverse.org/reference/is_tests.md)
  and
  [`is_theme()`](https://ggplot2.tidyverse.org/reference/is_tests.md).
- New [`get_labs()`](https://ggplot2.tidyverse.org/reference/labs.md)
  function for retrieving completed plot labels
  ([@teunbrand](https://github.com/teunbrand),
  [\#6008](https://github.com/tidyverse/ggplot2/issues/6008)).
- New
  [`get_geom_defaults()`](https://ggplot2.tidyverse.org/reference/get_geom_defaults.md)
...
- Patterns and gradients are now also enabled in
  [`geom_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md)
  ([@teunbrand](https://github.com/teunbrand),
  [\#5716](https://github.com/tidyverse/ggplot2/issues/5716)).
- The default behaviour of
  [`resolution()`](https://ggplot2.tidyverse.org/reference/resolution.md)
...
- When facets coerce the faceting variables to factors, the ‘ordered’
  class is dropped ([@teunbrand](https://github.com/teunbrand),
  [\#5666](https://github.com/tidyverse/ggplot2/issues/5666)).
- [`coord_map()`](https://ggplot2.tidyverse.org/reference/coord_map.md)
  and
  [`coord_polar()`](https://ggplot2.tidyverse.org/reference/coord_radial.md)
...
- [`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.md) now
  offers to install svglite if needed
...
- The guide system. As a whole. See ‘new features’ for more information.
  ...
  [`guide_train()`](https://ggplot2.tidyverse.org/reference/old_guide.md),
  [`guide_merge()`](https://ggplot2.tidyverse.org/reference/old_guide.md),
  [`guide_geom()`](https://ggplot2.tidyverse.org/reference/old_guide.md),
  [`guide_transform()`](https://ggplot2.tidyverse.org/reference/old_guide.md),
  [`guide_gengrob()`](https://ggplot2.tidyverse.org/reference/old_guide.md)
...
- The `legend.key` theme element is set to inherit from the
  ...
  [`theme_gray()`](https://ggplot2.tidyverse.org/reference/ggtheme.md)
...
- The `legend.text.align` and `legend.title.align` arguments in
  [`theme()`](https://ggplot2.tidyverse.org/reference/theme.md) are
...
- New function
  [`check_device()`](https://ggplot2.tidyverse.org/reference/check_device.md)
...
- The most user-facing change is that the styling of guides is rewired
  ...
  [`theme()`](https://ggplot2.tidyverse.org/reference/theme.md) has
...
- New
  [`guide_axis_stack()`](https://ggplot2.tidyverse.org/reference/guide_axis_stack.md)
...
- New
  [`guide_axis_logticks()`](https://ggplot2.tidyverse.org/reference/guide_axis_logticks.md)
  can be used to draw logarithmic tick marks as an axis. It supersedes
  the
  [`annotation_logticks()`](https://ggplot2.tidyverse.org/reference/annotation_logticks.md)
...
- The spacing between legend keys and their labels, in addition to
  ...
  [`theme()`](https://ggplot2.tidyverse.org/reference/theme.md). This
  leaves the `legend.spacing` theme setting dedicated to solely
...
- [`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) now
  uses customisable guides provided in the scales or
...
- [`draw_key_label()`](https://ggplot2.tidyverse.org/reference/draw_key.md)
...
- [`geom_violin()`](https://ggplot2.tidyverse.org/reference/geom_violin.md)
  ...
  [`geom_density()`](https://ggplot2.tidyverse.org/reference/geom_density.md)s
  ([@eliocamp](https://github.com/eliocamp),
...
- The
  [`translate_shape_string()`](https://ggplot2.tidyverse.org/reference/translate_shape_string.md)
...
- In [`theme()`](https://ggplot2.tidyverse.org/reference/theme.md), some
  elements can be specified with
  [`rel()`](https://ggplot2.tidyverse.org/reference/element.md) to
  inherit from `unit`-class objects in a relative fashion
  ([@teunbrand](https://github.com/teunbrand),
  [\#3951](https://github.com/tidyverse/ggplot2/issues/3951)).

- [`theme()`](https://ggplot2.tidyverse.org/reference/theme.md) now
...
- New `plot.tag.location` in
  [`theme()`](https://ggplot2.tidyverse.org/reference/theme.md) can
...
- The
  [`get_guide_data()`](https://ggplot2.tidyverse.org/reference/get_guide_data.md)
...
- [`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.md) no
...
- [`stage()`](https://ggplot2.tidyverse.org/reference/aes_eval.md) now
  works correctly, even with aesthetics that do not have scales
...
- Fixed bug in
  [`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) where
  graticule lines didn’t obey `panel.grid.major`’s linewidth setting
  ([@teunbrand](https://github.com/teunbrand),
...
- The default width of
  [`geom_bar()`](https://ggplot2.tidyverse.org/reference/geom_bar.md) is
  now based on panel-wise resolution of the data, rather than global
...
- [`fortify()`](https://ggplot2.tidyverse.org/reference/fortify.md) for
  sp objects (e.g., `SpatialPolygonsDataFrame`) is now deprecated and
  will be removed soon in support of [the upcoming retirement of rgdal,
  rgeos, and
...
- The
  [`layer_data()`](https://ggplot2.tidyverse.org/reference/ggplot_build.md),
  [`layer_scales()`](https://ggplot2.tidyverse.org/reference/ggplot_build.md)
  and
  [`layer_grob()`](https://ggplot2.tidyverse.org/reference/ggplot_build.md)
  now have the default `plot = last_plot()`
  ([@teunbrand](https://github.com/teunbrand),
  [\#5166](https://github.com/tidyverse/ggplot2/issues/5166)).

- The
  [`datetime_scale()`](https://ggplot2.tidyverse.org/reference/datetime_scale.md)
...
- Fixed spurious warnings when the `weight` was used in
  ...
  [`stat_boxplot()`](https://ggplot2.tidyverse.org/reference/geom_boxplot.md),
  [`stat_contour()`](https://ggplot2.tidyverse.org/reference/geom_contour.md),
  [`stat_bin_hex()`](https://ggplot2.tidyverse.org/reference/geom_hex.md)
  and
...
- To prevent changing the plotting order,
  [`stat_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) is now
  computed per panel instead of per group
  ([@teunbrand](https://github.com/teunbrand),
...
- Added
  [`scale_linewidth_manual()`](https://ggplot2.tidyverse.org/reference/scale_manual.md)
  and
  [`scale_linewidth_identity()`](https://ggplot2.tidyverse.org/reference/scale_identity.md)
  to support the `linewidth` aesthetic
  ([@teunbrand](https://github.com/teunbrand),
  [\#5050](https://github.com/tidyverse/ggplot2/issues/5050)).

- [`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.md) warns
  when multiple `filename`s are given, and only writes to the first file
  ([@teunbrand](https://github.com/teunbrand),
...
- Fixed misbehaviour of
  [`draw_key_boxplot()`](https://ggplot2.tidyverse.org/reference/draw_key.md)
  and
  [`draw_key_crossbar()`](https://ggplot2.tidyverse.org/reference/draw_key.md)
...
- The default line width for polygons in
  [`geom_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) have
  been decreased to 0.2 to reflect that this is usually used for
  demarking borders where a thinner line is better suited. This change
  was made since we already induced a visual change in
  [`geom_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) with
  the introduction of the `linewidth` aesthetic.

- The dot-dot notation (`..var..`) and
  [`stat()`](https://ggplot2.tidyverse.org/reference/aes_eval.md), which
...
- [`qplot()`](https://ggplot2.tidyverse.org/reference/qplot.md) is now
  formally deprecated
  ([@yutannihilation](https://github.com/yutannihilation),
  [\#3956](https://github.com/tidyverse/ggplot2/issues/3956)).

- [`stage()`](https://ggplot2.tidyverse.org/reference/aes_eval.md) now
  properly refers to the values without scale transformations for the
  stage of `after_stat`. If your code requires the scaled version of the
  values for some reason, you have to apply the same transformation by
  yourself, e.g. [`sqrt()`](https://rdrr.io/r/base/MathFun.html) for
  `scale_{x,y}_sqrt()`
...
- referring to `x` in backquoted expressions with
  [`label_bquote()`](https://ggplot2.tidyverse.org/reference/label_bquote.md)
...
- [`theme()`](https://ggplot2.tidyverse.org/reference/theme.md) now has
  a `strip.clip` argument, that can be set to `"off"` to prevent the
...
- [`aes()`](https://ggplot2.tidyverse.org/reference/aes.md) now supports
  the `!!!` operator in its first two arguments
...
- [`geom_tile()`](https://ggplot2.tidyverse.org/reference/geom_tile.md)
...
- Better compatibility of custom device functions in
  [`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.md)
  ([@thomasp85](https://github.com/thomasp85),
...
- Dots in
  [`geom_dotplot()`](https://ggplot2.tidyverse.org/reference/geom_dotplot.md)
...
- Fixes an issue in
  [`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.md) when
  producing emf/wmf files
  ([@yutannihilation](https://github.com/yutannihilation),
...
- Fix an issue where
  [`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) was
  reporting that it is non-linear even when data is provided in
...
- [`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) now
  has an argument `default_crs` that specifies the coordinate reference
  system (CRS) for non-sf layers and scale/coord limits. This argument
  defaults to `NULL`, which means non-sf layers are assumed to be in
  ...
  by [`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md).
  Authors of extension packages implementing
  [`stat_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md)-like
  functionality are encouraged to look at the source code of
  [`stat_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md)’s
...
- [`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.md) now
  uses ragg to render raster output if ragg is available. It also
...
- [`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.md) now
  returns the saved file location invisibly
...
- [`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.md) now
  sets the default background to match the fill value of the
...
- Fix a bug in
  [`qplot()`](https://ggplot2.tidyverse.org/reference/qplot.md) when
...
- Fixed a bug in
  [`labeller()`](https://ggplot2.tidyverse.org/reference/labeller.md) so
  that `.default` is passed to
  [`as_labeller()`](https://ggplot2.tidyverse.org/reference/as_labeller.md)
...
- [`annotation_raster()`](https://ggplot2.tidyverse.org/reference/annotation_raster.md)
...
- A newly added geom
  [`geom_density_2d_filled()`](https://ggplot2.tidyverse.org/reference/geom_density_2d.md)
  and associated stat
  [`stat_density_2d_filled()`](https://ggplot2.tidyverse.org/reference/geom_density_2d.md)
...
- A newly added
  ...
  e.g. [`scale_y_log10()`](https://ggplot2.tidyverse.org/reference/scale_continuous.md),
...
- Fixed a bug in
  [`geom_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) that
  caused problems with legend-type autodetection
  ([@clauswilke](https://github.com/clauswilke),
...
- Default discrete color scales are now configurable through the
  ...
  [`help(scale_colour_discrete)`](https://ggplot2.tidyverse.org/reference/scale_colour_discrete.md)
...
- Default continuous colour scales (i.e., the
  ...
  [`continuous_scale()`](https://ggplot2.tidyverse.org/reference/continuous_scale.md)s
  ([@cpsievert](https://github.com/cpsievert),
...
- The evaluation time of aesthetics can now be controlled to a finer
  ...
  [`stat()`](https://ggplot2.tidyverse.org/reference/aes_eval.md) and
  `..var..`-notation, and is joined by
  [`after_scale()`](https://ggplot2.tidyverse.org/reference/aes_eval.md)
  to allow for mapping to scaled aesthetic values. Remapping of the same
  aesthetic is now supported with
  [`stage()`](https://ggplot2.tidyverse.org/reference/aes_eval.md), so
  you can map a data variable to a stat aesthetic, and remap the same
...
- Position guides can now be customized using the new
  ...
  [`guides()`](https://ggplot2.tidyverse.org/reference/guides.md). The
  new axis guide
  ([`guide_axis()`](https://ggplot2.tidyverse.org/reference/guide_axis.md))
...
- Added
  [`stat_contour_filled()`](https://ggplot2.tidyverse.org/reference/geom_contour.md)
  and
  [`geom_contour_filled()`](https://ggplot2.tidyverse.org/reference/geom_contour.md),
...
- The newly added function
  [`register_theme_elements()`](https://ggplot2.tidyverse.org/reference/register_theme_elements.md)
...
- [`expand_scale()`](https://ggplot2.tidyverse.org/reference/expansion.md)
...
- [`gg_dep()`](https://ggplot2.tidyverse.org/reference/gg_dep.md) was
  deprecated ([@perezp44](https://github.com/perezp44),
...
- [`stat_density2d()`](https://ggplot2.tidyverse.org/reference/geom_density_2d.md)
...
- Using [`qplot()`](https://ggplot2.tidyverse.org/reference/qplot.md)
...
- Layers now have a new member function `setup_layer()` which is called
  ...
  [`layer_sf()`](https://ggplot2.tidyverse.org/reference/layer_sf.md)
...
- [`cut_width()`](https://ggplot2.tidyverse.org/reference/cut_interval.md)
  now accepts `...` to pass further arguments to
  [`base::cut.default()`](https://rdrr.io/r/base/cut.html) like
  [`cut_number()`](https://ggplot2.tidyverse.org/reference/cut_interval.md)
  and
  [`cut_interval()`](https://ggplot2.tidyverse.org/reference/cut_interval.md)
...
- ggplot2 no longer attaches any external packages when using functions
  ...
  [`stat_summary_hex()`](https://ggplot2.tidyverse.org/reference/stat_summary_2d.md),
...
- [`guide_legend()`](https://ggplot2.tidyverse.org/reference/guide_legend.md)
  and
  [`guide_colorbar()`](https://ggplot2.tidyverse.org/reference/guide_colourbar.md)
...
- [`scale_color_continuous()`](https://ggplot2.tidyverse.org/reference/scale_colour_continuous.md)
  now points to
  [`scale_colour_continuous()`](https://ggplot2.tidyverse.org/reference/scale_colour_continuous.md)
...
- In non-user-facing internal code (specifically in the
  [`aes()`](https://ggplot2.tidyverse.org/reference/aes.md) function and
  in the `aesthetics` argument of scale functions), ggplot2 now always
  uses the British spelling for aesthetics containing the word “colour”.
  When users specify a “color” aesthetic it is automatically renamed to
  “colour”. This renaming is also applied to non-standard aesthetics
  that contain the word “color”. For example, “point_color” is renamed
  to “point_colour”. This convention makes it easier to support both
  British and American spelling for novel, non-standard aesthetics, but
  it may require some adjustment for packages that have previously
  introduced non-standard color aesthetics using American spelling. A
  new function
  [`standardise_aes_names()`](https://ggplot2.tidyverse.org/reference/standardise_aes_names.md)
...
- [`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) has
  much improved customization of axis tick labels. Labels can now be set
  manually, and there are two new parameters, `label_graticule` and
...
- Two new geoms
  [`geom_sf_label()`](https://ggplot2.tidyverse.org/reference/ggsf.md)
  and
  [`geom_sf_text()`](https://ggplot2.tidyverse.org/reference/ggsf.md)
  can draw labels and text on sf objects. Under the hood, a new
  [`stat_sf_coordinates()`](https://ggplot2.tidyverse.org/reference/stat_sf_coordinates.md)
...
- For faceted plots, data is no longer internally reordered. This makes
  ...
  [`aes()`](https://ggplot2.tidyverse.org/reference/aes.md) or into
  parameters of geoms or stats. However, doing so remains discouraged
  ([@clauswilke](https://github.com/clauswilke),
  [\#2694](https://github.com/tidyverse/ggplot2/issues/2694)).

- [`coord_sf()`](https://ggplot2.tidyverse.org/reference/ggsf.md) now
  also understands the `clip` argument, just like the other coords
  ([@clauswilke](https://github.com/clauswilke),
  [\#2938](https://github.com/tidyverse/ggplot2/issues/2938)).

- [`fortify()`](https://ggplot2.tidyverse.org/reference/fortify.md) now
  displays a more informative error message for
...
- [`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.md) now
  exits without creating a new graphics device if previously none was
  open ([@clauswilke](https://github.com/clauswilke),
  [\#2363](https://github.com/tidyverse/ggplot2/issues/2363)).

- [`labs()`](https://ggplot2.tidyverse.org/reference/labs.md) now has
  named arguments `title`, `subtitle`, `caption`, and `tag`. Also,
  [`labs()`](https://ggplot2.tidyverse.org/reference/labs.md) now
  accepts tidyeval
  ([@yutannihilation](https://github.com/yutannihilation),
...
- [`stat_contour()`](https://ggplot2.tidyverse.org/reference/geom_contour.md),
  [`stat_density2d()`](https://ggplot2.tidyverse.org/reference/geom_density_2d.md),
  [`stat_bin2d()`](https://ggplot2.tidyverse.org/reference/geom_bin_2d.md),
  [`stat_binhex()`](https://ggplot2.tidyverse.org/reference/geom_hex.md)
...
- ggplot2 now supports/uses tidy evaluation (as described below). This
  ...
  [`aes()`](https://ggplot2.tidyverse.org/reference/aes.md) now contains
  quosures (expression + environment pairs) rather than symbols, and
  you’ll need to take a different approach to extracting the information
  you need. A common symptom of this change are errors “undefined
  columns selected” or “invalid ‘type’ (list) of argument”
  ...
  string, use
  [`quo_name()`](https://ggplot2.tidyverse.org/reference/tidyeval.md)
...
- The long-deprecated `subset` argument to
  [`layer()`](https://ggplot2.tidyverse.org/reference/layer.md) has been
  removed.

### Tidy evaluation

- [`aes()`](https://ggplot2.tidyverse.org/reference/aes.md) now supports
  quasiquotation so that you can use `!!`, `!!!`, and `:=`. This
  replaces [`aes_()`](https://ggplot2.tidyverse.org/reference/aes_.md)
  and [`aes_string()`](https://ggplot2.tidyverse.org/reference/aes_.md)
...
- [`facet_wrap()`](https://ggplot2.tidyverse.org/reference/facet_wrap.md)
  ...
  [`facet_grid()`](https://ggplot2.tidyverse.org/reference/facet_grid.md)
  now support
  [`vars()`](https://ggplot2.tidyverse.org/reference/vars.md) inputs.
  Like
  ...
  deprecated.
  [`vars()`](https://ggplot2.tidyverse.org/reference/vars.md) is simply
  ...
  [`vars()`](https://ggplot2.tidyverse.org/reference/vars.md) inputs.
  Note however that we took special care to ensure complete backward
  compatibility. With this change `facet_grid(vars(cyl), vars(am, vs))`
  is equivalent to `facet_grid(cyl ~ am + vs)`, and
  `facet_grid(cols = vars(am, vs))` is equivalent to
  `facet_grid(. ~ am + vs)`.
...
- New syntax for calculated aesthetics. Instead of using
  ...
  [`stat()`](https://ggplot2.tidyverse.org/reference/aes_eval.md) is a
  real function with documentation which hopefully will make this part
  of ggplot2 less confusing
  ([\#2059](https://github.com/tidyverse/ggplot2/issues/2059)).

  [`stat()`](https://ggplot2.tidyverse.org/reference/aes_eval.md) is
...
- New
  [`scale_colour_viridis_c()`](https://ggplot2.tidyverse.org/reference/scale_viridis.md)/[`scale_fill_viridis_c()`](https://ggplot2.tidyverse.org/reference/scale_viridis.md)
  (continuous) and
  [`scale_colour_viridis_d()`](https://ggplot2.tidyverse.org/reference/scale_viridis.md)/[`scale_fill_viridis_d()`](https://ggplot2.tidyverse.org/reference/scale_viridis.md)
...
- New
  [`autolayer()`](https://ggplot2.tidyverse.org/reference/autolayer.md)
  S3 generic
  ([@mitchelloharawild](https://github.com/mitchelloharawild),
  [\#1974](https://github.com/tidyverse/ggplot2/issues/1974)). This is
  similar to
  [`autoplot()`](https://ggplot2.tidyverse.org/reference/autoplot.md)
...
- [`scale_type()`](https://ggplot2.tidyverse.org/reference/scale_type.md)
...
- [`label_parsed()`](https://ggplot2.tidyverse.org/reference/labellers.md)
  works once again
...
- Three new generic scales work with any aesthetic or set of aesthetics:
  [`scale_continuous_identity()`](https://ggplot2.tidyverse.org/reference/scale_identity.md),
  [`scale_discrete_identity()`](https://ggplot2.tidyverse.org/reference/scale_identity.md),
  and
  [`scale_discrete_manual()`](https://ggplot2.tidyverse.org/reference/scale_manual.md)
  ([@clauswilke](https://github.com/clauswilke)).
...
- [`layer()`](https://ggplot2.tidyverse.org/reference/layer.md) gives
  considerably better error messages for incorrectly specified `geom`,
  `stat`, or `position`
...
- Default themes use
  [`rel()`](https://ggplot2.tidyverse.org/reference/element.md) to set
  line widths ([@baptiste](https://github.com/baptiste)).
...
- [`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.md)’s DPI
  argument now supports 3 string options: “retina” (320 DPI), “print”
  (300 DPI), and “screen” (72 DPI)
  ([@foo-bar-baz-qux](https://github.com/foo-bar-baz-qux),
  [\#2156](https://github.com/tidyverse/ggplot2/issues/2156)).
  [`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.md) now
  uses full argument names to avoid partial match warnings
...
- New functions
  [`summarise_layout()`](https://ggplot2.tidyverse.org/reference/summarise_plot.md),
  [`summarise_coord()`](https://ggplot2.tidyverse.org/reference/summarise_plot.md),
  and
  [`summarise_layers()`](https://ggplot2.tidyverse.org/reference/summarise_plot.md)
...
[`ggtitle()`](https://ggplot2.tidyverse.org/reference/labs.md) and
[`labs()`](https://ggplot2.tidyverse.org/reference/labs.md). You can
...
[`geom_col()`](https://ggplot2.tidyverse.org/reference/geom_bar.md) was
added to complement
[`geom_bar()`](https://ggplot2.tidyverse.org/reference/geom_bar.md)
...
- New
  [`scale_x_time()`](https://ggplot2.tidyverse.org/reference/scale_date.md)
  and
  [`scale_y_time()`](https://ggplot2.tidyverse.org/reference/scale_date.md)
...
1.  [`scale_x_discrete()`](https://ggplot2.tidyverse.org/reference/scale_discrete.md)
    and
    [`scale_y_discrete()`](https://ggplot2.tidyverse.org/reference/scale_discrete.md)
...
- Class of aesthetic mapping is preserved when adding
  [`aes()`](https://ggplot2.tidyverse.org/reference/aes.md) objects
...
- [`layer()`](https://ggplot2.tidyverse.org/reference/layer.md) gains
  new `check.aes` and `check.param` arguments. These allow geom/stat
  authors to optional suppress checks for known aesthetics/parameters.
...
- [`layer()`](https://ggplot2.tidyverse.org/reference/layer.md) now
...
- [`theme_update()`](https://ggplot2.tidyverse.org/reference/get_theme.md)
  now uses the `+` operator instead of `%+replace%`, so that unspecified
  values will no longer be `NULL`ed out.
  [`theme_replace()`](https://ggplot2.tidyverse.org/reference/get_theme.md)
...
- All `geom_()` and `stat_()` functions now have consistent argument
  ...
  [`geom_density2d()`](https://ggplot2.tidyverse.org/reference/geom_density_2d.md)
...
- [`facet_wrap()`](https://ggplot2.tidyverse.org/reference/facet_wrap.md)/[`facet_grid()`](https://ggplot2.tidyverse.org/reference/facet_grid.md)
...
- [`scale_size()`](https://ggplot2.tidyverse.org/reference/scale_size.md)
  ...
  [`scale_radius()`](https://ggplot2.tidyverse.org/reference/scale_size.md)
...
- New
  ...
  default to
  [`mean_se()`](https://ggplot2.tidyverse.org/reference/mean_se.md) if
  no aggregation functions are supplied
...
- Layers are now much stricter about their arguments - you will get an
  ...
  [`geom_smooth()`](https://ggplot2.tidyverse.org/reference/geom_smooth.md)/[`stat_smooth()`](https://ggplot2.tidyverse.org/reference/geom_smooth.md)
  and
  [`geom_quantile()`](https://ggplot2.tidyverse.org/reference/geom_quantile.md)/[`stat_quantile()`](https://ggplot2.tidyverse.org/reference/geom_quantile.md)
  ...
  [`stat_summary_hex()`](https://ggplot2.tidyverse.org/reference/stat_summary_2d.md),
  and
  [`stat_summary2d()`](https://ggplot2.tidyverse.org/reference/stat_summary_2d.md)
  use `fun.args`.
...
- [`aes_()`](https://ggplot2.tidyverse.org/reference/aes_.md) replaces
  [`aes_q()`](https://ggplot2.tidyverse.org/reference/aes_.md). It also
...
- The little used
  [`aes_auto()`](https://ggplot2.tidyverse.org/reference/aes_auto.md)
  has been deprecated.

- [`aes_q()`](https://ggplot2.tidyverse.org/reference/aes_.md) has been
  replaced with
  [`aes_()`](https://ggplot2.tidyverse.org/reference/aes_.md) to be
...
- The `stat` and `position` arguments to
  [`qplot()`](https://ggplot2.tidyverse.org/reference/qplot.md) have
  been deprecated.
  [`qplot()`](https://ggplot2.tidyverse.org/reference/qplot.md) is
  designed for quick plots - if you need to specify position or stat,
  use [`ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.md)
  instead.
...
- [`stat_binhex()`](https://ggplot2.tidyverse.org/reference/geom_hex.md)
  ...
  has been renamed to
  [`stat_summary_2d()`](https://ggplot2.tidyverse.org/reference/stat_summary_2d.md),
  [`geom_density2d()`](https://ggplot2.tidyverse.org/reference/geom_density_2d.md)/[`stat_density2d()`](https://ggplot2.tidyverse.org/reference/geom_density_2d.md)
  has been renamed to
  [`geom_density_2d()`](https://ggplot2.tidyverse.org/reference/geom_density_2d.md)/[`stat_density_2d()`](https://ggplot2.tidyverse.org/reference/geom_density_2d.md).

- [`stat_spoke()`](https://ggplot2.tidyverse.org/reference/geom_spoke.md)
  is now
  [`geom_spoke()`](https://ggplot2.tidyverse.org/reference/geom_spoke.md)
...
- New
  [`theme_dark()`](https://ggplot2.tidyverse.org/reference/ggtheme.md)
  has a dark background designed to make colours pop out
  ([@jiho](https://github.com/jiho),
  [\#1018](https://github.com/tidyverse/ggplot2/issues/1018))

- [`theme_minimal()`](https://ggplot2.tidyverse.org/reference/ggtheme.md)
...
[`label_value()`](https://ggplot2.tidyverse.org/reference/labellers.md)
or
[`label_both()`](https://ggplot2.tidyverse.org/reference/labellers.md))
...
- Similarly to
  ...
  `.default`.
  [`labeller()`](https://ggplot2.tidyverse.org/reference/labeller.md) is
  useful to customise how particular variables are labelled. The three
...
- The new labeller
  [`label_context()`](https://ggplot2.tidyverse.org/reference/labellers.md)
...
- Improved documentation for
  [`aes()`](https://ggplot2.tidyverse.org/reference/aes.md),
  [`layer()`](https://ggplot2.tidyverse.org/reference/layer.md) and much
  much more.
...
- Use of [`qplot()`](https://ggplot2.tidyverse.org/reference/qplot.md)
  ...
  [`qplot()`](https://ggplot2.tidyverse.org/reference/qplot.md) in
  favour of
  [`ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.md).

- Tightly linked geoms and stats
  (e.g. [`geom_boxplot()`](https://ggplot2.tidyverse.org/reference/geom_boxplot.md)
  and
  [`stat_boxplot()`](https://ggplot2.tidyverse.org/reference/geom_boxplot.md))
  are now documented in the same file so you can see all the arguments
  in one place. Variations of the same idea
  (e.g. [`geom_path()`](https://ggplot2.tidyverse.org/reference/geom_path.md),
  [`geom_line()`](https://ggplot2.tidyverse.org/reference/geom_path.md),
  and
  [`geom_step()`](https://ggplot2.tidyverse.org/reference/geom_path.md))
...
- [`aes_string()`](https://ggplot2.tidyverse.org/reference/aes_.md) now
  only parses character inputs. This fixes bugs when using it with
  numbers and non default `OutDec` settings
  ([\#1045](https://github.com/tidyverse/ggplot2/issues/1045)).

- [`annotation_custom()`](https://ggplot2.tidyverse.org/reference/annotation_custom.md)
...
- [`geom_bin2d()`](https://ggplot2.tidyverse.org/reference/geom_bin_2d.md)
...
- [`ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.md) now
  captures the parent frame to use for evaluation, rather than always
  defaulting to the global environment. This should make ggplot more
  suitable to use in more situations (e.g. with knitr)

- [`ggsave()`](https://ggplot2.tidyverse.org/reference/ggsave.md) has
  been simplified a little to make it easier to maintain. It no longer
  checks that you’re printing a ggplot2 object (so now also works with
  any grid grob)
...
- [`lims()`](https://ggplot2.tidyverse.org/reference/lims.md) makes it
  easy to set the limits of any axis
...
- [`theme()`](https://ggplot2.tidyverse.org/reference/theme.md) gains
  `validate = FALSE` parameter to turn off validation, and hence store
  arbitrary additional data in the themes.
