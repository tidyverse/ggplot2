...
test_that("scales generated by ScaleList$add_missing() have appropriate calls", {
  sc <- scales_list()
  sc$add_missing(c("x", "y"), current_env())
  expect_equal(as_label(sc$get_scales("x")$call), "scale_x_continuous()")
  expect_equal(as_label(sc$get_scales("y")$call), "scale_y_continuous()")
})
