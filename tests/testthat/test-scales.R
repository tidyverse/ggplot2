...
test_that("all-Inf layers are not used for determining the type of scale", {
  ...
  b2 <- ggplot_build(p2)
  expect_s3_class(b2$layout$panel_scales$x[[1]], "ScaleContinuousPosition")
})
