...
test_that("layout summary - reversed scales", {
  ...
  expect_equal(lr$xscale[[1]]$transformer$name, "reverse")
  expect_equal(lr$xscale[[1]]$transformer$transform(5), -5)
})
...
test_that("layout summary - log scales", {
  ...
  expect_equal(ll$xscale[[1]]$transformer$name, "log-10")
  expect_equal(ll$xscale[[1]]$transformer$transform(100), 2)
  expect_equal(ll$yscale[[1]]$transformer$name, "log-2")
  expect_equal(ll$yscale[[1]]$transformer$transform(16), 4)
})
